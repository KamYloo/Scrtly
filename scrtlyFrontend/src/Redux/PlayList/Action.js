...
export const getUserPlayLists = () => async (dispatch) => {
    await dispatchAction(dispatch, GET_USER_PLAYLISTS_REQUEST, GET_USER_PLAYLISTS_SUCCESS, GET_USER_PLAYLISTS_ERROR, '/playLists/user', {
        method: 'GET',
        credentials: 'include',
    });
};
...
export const getPlayListTracks = (playListId) => async (dispatch) => {
    await dispatchAction(dispatch, GET_PLAYLIST_TRACKS_REQUEST, GET_PLAYLIST_TRACKS_SUCCESS, GET_PLAYLIST_TRACKS_ERROR, `/playLists/${playListId}/tracks`, {
        method: 'GET',
        credentials: 'include',
    });
}
