...
import {
    ...
    LOGIN_ERROR,
    REGISTER_REQUEST,
    REGISTER_ERROR, LOGOUT_REQUEST, LOGOUT_ERROR, FIND_USER_REQUEST, FIND_USER_ERROR
} from "./ActionType"
...
export const findUser = (nickName) => async (dispatch) => {
    await dispatchAction(dispatch, FIND_USER_REQUEST, FIND_USER_ERROR, `/api/user/profile/${nickName}`, {
        method: 'GET',
        credentials: 'include',
    });
}
...
export const followUser = (userId) => async (dispatch) => {
    await dispatchAction(dispatch, FOLLOW_USER_REQUEST, FOLLOW_USER_ERROR, `/api/user/follow/${userId}`, {
        method: 'PUT',
        credentials: 'include',
    });
}
...
export const searchUser = (data) => async (dispatch) => {
    await dispatchAction(dispatch, SEARCH_USER_REQUEST, SEARCH_USER_ERROR, `/api/user/search?name=${data.keyword}`, {
        method: 'GET',
        credentials: 'include',
    });
}
...
export const updateUser = (formData) => async (dispatch) => {
    return await dispatchAction(dispatch, UPDATE_USER_REQUEST, UPDATE_USER_ERROR, '/api/user/profile/edit', {
        method: 'PUT',
        body: formData,
        credentials: 'include',
    });
