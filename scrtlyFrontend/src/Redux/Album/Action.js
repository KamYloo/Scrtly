...
export const getAllAlbums = () => async (dispatch) => {
    await dispatchAction(dispatch, GET_ALL_ALBUMS_REQUEST, GET_ALL_ALBUMS_ERROR, '/api/albums/all', {
        method: 'GET',
        credentials: 'include',
    });
};
...
export const deleteAlbum = (albumId) => async (dispatch) => {
    await dispatchAction(dispatch, DELETE_ALBUM_REQUEST, DELETE_ALBUM_ERROR, `/api/albums/delete/${albumId}`, {
        method: 'DELETE',
        credentials: 'include',
    });
};
